...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, size, children, withSubmitBtn, submitBtnFunction }) => {
    ...
    let modalSizeClass = "bg-white rounded-lg py-5 px-6 w-96";
    if(size == "large") {
        modalSizeClass = "bg-white rounded-lg py-5 px-6 xl:w-150 lg:w-100 md:w-100 sm:w-96";
    }
    else if(size == "medium") {
        modalSizeClass = "bg-white rounded-lg py-5 px-6 w-100 sm:w-96";
    }
    else if(size == "small") {
        modalSizeClass = "bg-white rounded-lg py-5 px-6 w-96";
    }
